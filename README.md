...
- When the phone is unlocked, completed flights touching the most recent local travel date animate chronologically along the final portion of their routes. A flight departing Friday and landing Saturday is therefore followed by a second Saturday flight. The normal wallpaper appears for one second between flights. A bright dot in the selected trail colour marks the moving aircraft. Unlock requests are retained until the wallpaper becomes visible, and radar refreshing waits until the sequence is complete. These animations reuse the cached wallpaper frame and perform no radar downloads.
